...
goods = []
while input("Вы желаете добавить продукт? да/нет:") == "да":
    number = int(input("Введите порядковый номер продукта:"))
    features = {}
    while input("Вы желаете добавить характеристику для продукта? да/нет:") == "да":
