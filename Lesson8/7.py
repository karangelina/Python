...
class ComplexNumber:
    ...
    def __mul__(self, other):
        return f"Произведение равно: {self.a * other.a - self.b * other.b} + {self.a * other.b + other.a * self.b} * i"


ComplexNumber_1 = ComplexNumber(1, 2)
ComplexNumber_2 = ComplexNumber(3, 4)
print(ComplexNumber_1 + ComplexNumber_2)
print(ComplexNumber_1 * ComplexNumber_2)